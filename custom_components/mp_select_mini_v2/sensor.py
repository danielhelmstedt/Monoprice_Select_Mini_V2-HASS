        ...
        try:
            async with (
                ...
                if response_data:
                    ...
                    ## Update input numbers for target temperatures
                    #if self._name == "Target Extruder Temperature":
                    #    self.hass.states.async_set("input_number.target_extruder_temperature", self._state)
                    #elif self._name == "Target Bed Temperature":
                    #    self.hass.states.async_set("input_number.target_bed_temperature", self
